        ...
        {step === "form" ? (
          <>
            ...
            <div className="mt-6 space-y-4">
              <Input label={t.profile.fullName} placeholder={t.profile.fullName} />
              <RadioGroup
              ...
              <Input label={t.auth.emailLabel} type="email" placeholder="your@email.com" />
            </div>
            ...
            <div className="mt-6">
              <label className="flex items-start gap-2 cursor-pointer">
                ...
                <span className="text-xs text-neutral-500">
                  I agree to the{" "}
                  <Link href="#" className="text-primary-600 hover:underline">Terms of Service</Link> and{" "}
          ...
          <>
            ...
            <p className="mt-1 text-sm text-neutral-500">
              Enter the 6-digit code sent to +91 {phone.slice(0, 2)}XXXXX{phone.slice(-2)}
            </p>
            ...
            <div className="mt-4 flex items-center justify-between text-sm">
              <span className="text-neutral-400">Resend OTP in 0:28</span>
              <button
            ...
            <Button variant="primary" size="lg" fullWidth className="mt-8" asChild>
              <Link href="/onboarding/1">Verify &amp; Continue</Link>
            </Button>
          </>
        )}
      </div>
